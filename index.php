...
<head>
	...
	<script type="text/javascript" href="js/animation.js"></script>
...
<body >
	...
	<header class="masthead" style="text-align: center;
		  ...
		  height: 700px;" id="masthead">
		      <div class="container text-center">
		        <div class="intro-text">
		          <div class="intro-lead-in">Welcome to my Website!</div>
		          <div class="intro-heading text-uppercase">It's Nice To Meet You</div>
		          <button class="btn btn-primary text-uppercase " id="tell" name="tell">Tell Me More</button>
		        </div>
		      </div>
    </header>
